(() => {
  ...
  function addPowerShell() {
    ...
    dialog.innerHTML = `
      <div class="powershell-card">
        ...
        <div class="powershell-quick" aria-label="PowerShell quick commands">
          ...
          <button type="button" data-ps-quick="hv-access">Hyper-V Access</button>
          <button type="button" data-ps-quick="hv-status">HV Access Status</button>
    ...
    const quickCommands = {
      ...
      'hv-access': `Set-Location 'B:\\Mini-Remote-Desktop'\n& '.\\scripts\\setup-hyperv-access.ps1'`,
      'hv-status': `Set-Location 'B:\\Mini-Remote-Desktop'\n& '.\\scripts\\setup-hyperv-access.ps1' -StatusOnly`,
